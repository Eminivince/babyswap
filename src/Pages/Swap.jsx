...
function Swap() {
  ...
  return (
    <div className="bg-gray-300 min-h-screen relative px-3  bg-cover">
      ...
      <div className="pt-[100px]">
        ...
        {!confirmSwap ? (
          <div>
            <section className="w-full max-w-[400px] sm:w-[400px] h-[432px] px-3 sm:px-[24px] pt-[24px] pb-[32px] bg-purple-900 text-white shadow-purple-950 shadow-xl rounded-xl m-auto">
              ...
              <div>
                <div>
                  <h3 className="text-[15px] mb-2 animate-pulse">Swap from</h3>
                  <div className="flex justify-between relative">
                    <input
                      ...
                      placeholder="0"
                      className="w-[40%] sm:w-[230px] pr-[8%] sm:pr-[25px] bg-purple-900 shadow shadow-purple-900 rounded-2xl outline-none text-[15px] sm:text-[30px] pl-2"
                    />
                    <i
                      className={`absolute left-[75%] sm:left-[210px] top-1/2 -translate-y-1/2 cursor-pointer border w-[20px] h-[20px] rounded-full ${
                        swapInputs.from
                    ...
                    >
                      <div className='flex items-center mb-4 bg-purple-500 p-2 rounded-lg'>
                      <img
                ...
                <div className="bg-white h-[2px] my-7 flex items-center justify-end">
                  <button
                    className="bg-purple-500 w-[40px] h-[40px] rounded-full flex items-center justify-center cursor-pointer"
                ...
                <div>
                  ...
                  <div className="flex justify-between">
                    ...
                    {defaultTokenSwapTo?.name ? (
                      ...
                      <button
                        className="flex items-center text-[#011718] bg-purple-500 w-[170px] h-[48px] justify-center rounded-lg hover:opacity-70 cursor-pointer"
                        onClick={() => {
                          if (!signer) checkIsConnected();
                          else {
              ...
              {fetchingPrice || pairAddressError ? (
                ...
                <button className="text-purple-800 h-[48px] w-full max-w-[384px] sm:w-[384px] bg-[#e0d8d8] block mt-7 rounded-lg">
                  Enter an Amount
                </button>
              )}
            </section>
