...
function Connect() {
  ...
  return (
    <main className="w-[100%] min-h-[100vh] p-3 flex flex-col items-center text-white pt-[40px]">
      <h3 className="mb-[50px] flex items-center">
        <img src={Xeleronlogo} alt="logo" className="mr-3" />
        Xeleron
      </h3>
      ...
      />
      <button
        className={`w-full max-w-[384px] sm:w-[384px] h-[56px] rounded-[100px] mb-12 ${
          password.user.length < 5
            ? "bg-[#1C3738] text-[#1B595B] cursor-none"
            : "bg-[#69CED1]"
        }`}
